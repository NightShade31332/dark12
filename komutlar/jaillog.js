...
exports.run = async(client, message, args) => {
   ...
   var başarılı = ['**Başarılı!** <a:onay:799547849536045056> ・  '];
   var x = başarılı[Math.floor(Math.random() * başarılı.length)];

   var başarısız = ['**Başarısız!** <a:red:799577133084049469> ・  '];
...
if (!args[0]) return message.reply(`Sistemi kullanabilmek için, +jail-log ayarla/sıfırla @rol yazmalısın.`)
